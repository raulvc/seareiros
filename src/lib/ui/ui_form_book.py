...
" }")
        ...
        BookForm.setTabOrder(self.edDescription, self.edSubject)
    ...
    def retranslateUi(self, BookForm):
        ...
        self.groupBox_2.setToolTip(QtGui.QApplication.translate("BookForm", "Temas", None, QtGui.QApplication.UnicodeUTF8))
