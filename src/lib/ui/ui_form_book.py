...
" }")
        ...
        self.comboAuthor = QtGui.QComboBox(self.groupBox)
        self.comboAuthor.setEditable(True)
        self.comboAuthor.setObjectName("comboAuthor")
        self.gridLayout.addWidget(self.comboAuthor, 2, 3, 1, 6)
        self.edTitle = QtGui.QLineEdit(self.groupBox)
        self.edTitle.setInputMethodHints(QtCore.Qt.ImhUppercaseOnly)
        self.edTitle.setObjectName("edTitle")
        self.gridLayout.addWidget(self.edTitle, 1, 3, 1, 6)
        self.edBarcode = QtGui.QLineEdit(self.groupBox)
        self.edBarcode.setObjectName("edBarcode")
        self.gridLayout.addWidget(self.edBarcode, 0, 2, 1, 7)
        ...
        self.comboSAuthor = QtGui.QComboBox(self.groupBox)
        self.comboSAuthor.setEditable(True)
        self.comboSAuthor.setObjectName("comboSAuthor")
        self.gridLayout.addWidget(self.comboSAuthor, 3, 3, 1, 6)
        spacerItem1 = QtGui.QSpacerItem(10, 20, QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Minimum)
        self.gridLayout.addItem(spacerItem1, 1, 1, 1, 1)
        self.comboPublisher = QtGui.QComboBox(self.groupBox)
        self.comboPublisher.setEditable(True)
        self.comboPublisher.setObjectName("comboPublisher")
        self.gridLayout.addWidget(self.comboPublisher, 4, 3, 1, 6)
        ...
        self.gridLayout.addWidget(self.label_5, 5, 6, 1, 1)
        self.label_6 = QtGui.QLabel(self.groupBox)
        self.label_6.setObjectName("label_6")
        self.gridLayout.addWidget(self.label_6, 0, 0, 1, 1)
        self.edDescription = QtGui.QTextEdit(self.groupBox)
        self.edDescription.setObjectName("edDescription")
        self.gridLayout.addWidget(self.edDescription, 7, 1, 1, 8)
        ...
        self.gridLayout.addWidget(self.edPrice, 5, 7, 1, 1)
...
" }")
        ...
        self.tableSubjects = QtGui.QTableWidget(self.groupBox_2)
        ...
        self.gridLayout_4.addWidget(self.tableSubjects, 1, 0, 1, 6)
        self.btnCleanSubjects = QtGui.QPushButton(self.groupBox_2)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/clean.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnCleanSubjects.setIcon(icon)
        self.btnCleanSubjects.setObjectName("btnCleanSubjects")
        self.gridLayout_4.addWidget(self.btnCleanSubjects, 0, 5, 1, 1)
        self.comboSubject = QtGui.QComboBox(self.groupBox_2)
        self.comboSubject.setEditable(True)
        self.comboSubject.setObjectName("comboSubject")
        self.gridLayout_4.addWidget(self.comboSubject, 0, 0, 1, 3)
        self.btnAddSubject = QtGui.QPushButton(self.groupBox_2)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/activity_add.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btnAddSubject.setIcon(icon1)
        self.btnAddSubject.setObjectName("btnAddSubject")
        self.gridLayout_4.addWidget(self.btnAddSubject, 0, 3, 1, 1)
        ...
        BookForm.setTabOrder(self.edTitle, self.comboAuthor)
        BookForm.setTabOrder(self.comboAuthor, self.comboSAuthor)
        BookForm.setTabOrder(self.comboSAuthor, self.comboPublisher)
        BookForm.setTabOrder(self.comboPublisher, self.edPrice)
        BookForm.setTabOrder(self.edPrice, self.edDescription)
        BookForm.setTabOrder(self.edDescription, self.comboSubject)
        BookForm.setTabOrder(self.comboSubject, self.btnAddSubject)
        BookForm.setTabOrder(self.btnAddSubject, self.tableSubjects)
        BookForm.setTabOrder(self.tableSubjects, self.btnCleanSubjects)
        BookForm.setTabOrder(self.btnCleanSubjects, self.graphicsView)
    ...
    def retranslateUi(self, BookForm):
        ...
        self.groupBox_2.setToolTip(QtGui.QApplication.translate("BookForm", "Atividades", None, QtGui.QApplication.UnicodeUTF8))
        self.groupBox_2.setTitle(QtGui.QApplication.translate("BookForm", "Temas", None, QtGui.QApplication.UnicodeUTF8))
